...
class CMVTest {
    ...
    void lic11_xDecreasesWithExactGap_returnsTrue() {
        ...
        assertTrue(CMV.lic11(points, gPts));
    }
    ...
    void lic11_noDecreaseWithExactGap_returnsFalse() {
        ...
        assertFalse(CMV.lic11(points, gPts));
    }
    ...
    /**
     * Off by one guard: ensure we require exactly gPts intervening points.
     * gPts = 1; correct pair is (0, 2).
     * Points: (5, 0) → (3, 0) → (5, 0).
     ...
     * gPts = 0; violates the constraint 1 ≤ G_PTS.
     * Points: (5, 0) → (3, 0) → (1, 0).
     * Expected: false.
     */
    @Test
    void lic11_invalidGPTSBelowMin_returnsFalse() {
        Point[] points = {
            new Point(5, 0),
            new Point(3, 0),
            new Point(1, 0)
     ...
     * gPts = 5; violates the constraint G_PTS ≤ NUMPOINTS - 2 (3 - 2 = 1).
     * Points: (5, 0) → (9, 0) → (3, 0).
     * Expected: false.
     */
    @Test
    void lic11_invalidGPTSAboveMax_returnsFalse() {
        Point[] points = {
            new Point(5, 0),
            new Point(9, 0),
            new Point(3, 0)
